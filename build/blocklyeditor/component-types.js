...
{ "name": "VersionCode", "editorType": "non_negative_integer", "defaultValue": "7"},
{ "name": "VersionName", "editorType": "string", "defaultValue": "1.6"}],
...
,
{ "name": "FtcAccelerationSensor",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an acceleration sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Status", "description": "The status.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"},
    { "name": "XAccel", "description": "The X Acceleration, in G's.", "type": "number", "rw": "read-only"},
    { "name": "YAccel", "description": "The Y Acceleration, in G's.", "type": "number", "rw": "read-only"},
    { "name": "ZAccel", "description": "The Z Acceleration, in G's.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcAnalogInput",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an analog input device of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Value", "description": "The current ADC results from the A0-A7 channel input pins.", "type": "number", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcAnalogOutput",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an analog output device of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    ...
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "SetAnalogOutputFrequency", "description": "Sets the channel output frequency in the range 1-5,000 Hz in mode 1, 2 or 3.", "deprecated": "false", "params": [{ "name": "frequency", "type": "number"}]},
    { "name": "SetAnalogOutputMode", "description": "Sets the channel operating mode.\nMode 0: Voltage output. Range: -4V - 4V.\nMode 1: Sine wave output. Range: 0 - 8V.\nMode 2: Square wave output. Range: 0 - 8V.\nMode 3: Triangle wave output. Range: 0 - 8V.", "deprecated": "false", "params": [{ "name": "mode", "type": "number"}]},
    { "name": "SetAnalogOutputVoltage", "description": "Sets the channel output voltage.\nIf mode == 0: takes input from -1023-1023, output in the range -4 to +4 volts.\nIf mode == 1, 2, or 3: takes input from 0-1023, output in the range 0 to 8 volts.", "deprecated": "false", "params": [{ "name": "voltage", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcColorSensor",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a color sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ARGB", "description": "The color detected by the sensor as an integer ARGB (alpha, red, green, blue) color.", "type": "number", "rw": "read-only"},
    { "name": "Alpha", "description": "The amount of light detected by the sensor as an integer.", "type": "number", "rw": "read-only"},
    { "name": "Blue", "description": "The blue value detected by the sensor as an integer.", "type": "number", "rw": "read-only"},
    { "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Green", "description": "The green value detected by the sensor as an integer.", "type": "number", "rw": "read-only"},
    { "name": "I2cAddress", "description": "The I2C address of the color sensor. Not all color sensors support this feature.", "type": "number", "rw": "read-write"},
    { "name": "MAX_NEW_I2C_ADDRESS", "description": "The constant for MAX_NEW_I2C_ADDRESS.", "type": "number", "rw": "read-only"},
    { "name": "MIN_NEW_I2C_ADDRESS", "description": "The constant for MIN_NEW_I2C_ADDRESS.", "type": "number", "rw": "read-only"},
    { "name": "Red", "description": "The red value detected by the sensor as an integer.", "type": "number", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ConvertColorToHSV", "description": "Convert an integer ARGB (alpha, red, green, blue) color to an HSV (hue, saturation, value).", "deprecated": "false", "params": [{ "name": "color", "type": "number"}], "returnType": "any"},
    { "name": "ConvertHSVToColor", "description": "Convert an HSV (hue, saturation, value) to an integer ARGB (alpha, red, green, blue) color.", "deprecated": "false", "params": [{ "name": "hsv", "type": "any"}], "returnType": "number"},
    { "name": "ConvertHSVToColorWithAlpha", "description": "Convert a specified alpha value and an HSV (hue, saturation, value) to an integer ARGB (alpha, red, green, blue) color.", "deprecated": "false", "params": [{ "name": "alpha", "type": "number"},{ "name": "hsv", "type": "any"}], "returnType": "number"},
    { "name": "ConvertRGBToHSV", "description": "Convert red, green, and blue values to an HSV (hue, saturation, value).", "deprecated": "false", "params": [{ "name": "red", "type": "number"},{ "name": "green", "type": "number"},{ "name": "blue", "type": "number"}], "returnType": "any"},
    { "name": "CreateARGB", "description": "Create an integer ARGB (alpha, red, green, blue) color from alpha, red, green, blue values.", "deprecated": "false", "params": [{ "name": "alpha", "type": "number"},{ "name": "red", "type": "number"},{ "name": "green", "type": "number"},{ "name": "blue", "type": "number"}], "returnType": "number"},
    { "name": "CreateHSV", "description": "Create an HSV (hue, saturation, value).", "deprecated": "false", "params": [{ "name": "hue", "type": "number"},{ "name": "saturation", "type": "number"},{ "name": "value", "type": "number"}], "returnType": "any"},
    { "name": "CreateRGB", "description": "Create an integer ARGB (alpha, red, green, blue) color from red, green, blue values.", "deprecated": "false", "params": [{ "name": "red", "type": "number"},{ "name": "green", "type": "number"},{ "name": "blue", "type": "number"}], "returnType": "number"},
    { "name": "EnableLed", "description": "Enable the LED light.", "deprecated": "false", "params": [{ "name": "enable", "type": "boolean"}]},
    { "name": "ExtractAlpha", "description": "Extract the alpha component of an integer ARGB (alpha, red, green, blue) color.", "deprecated": "false", "params": [{ "name": "color", "type": "number"}], "returnType": "number"},
    { "name": "ExtractBlue", "description": "Extract the blue component of an integer ARGB (alpha, red, green, blue) color.", "deprecated": "false", "params": [{ "name": "color", "type": "number"}], "returnType": "number"},
    { "name": "ExtractGreen", "description": "Extract the green component of an integer ARGB (alpha, red, green, blue) color.", "deprecated": "false", "params": [{ "name": "color", "type": "number"}], "returnType": "number"},
    { "name": "ExtractHue", "description": "Extract the hue from the given HSV (hue, saturation, value).", "deprecated": "false", "params": [{ "name": "hsv", "type": "any"}], "returnType": "number"},
    { "name": "ExtractRed", "description": "Extract the red component of an integer ARGB (alpha, red, green, blue) color.", "deprecated": "false", "params": [{ "name": "color", "type": "number"}], "returnType": "number"},
    { "name": "ExtractSaturation", "description": "Extract the saturation from the given HSV (hue, saturation, value).", "deprecated": "false", "params": [{ "name": "hsv", "type": "any"}], "returnType": "number"},
    { "name": "ExtractValue", "description": "Extract the value from the given HSV (hue, saturation, value).", "deprecated": "false", "params": [{ "name": "hsv", "type": "any"}], "returnType": "number"},
    { "name": "ParseColor", "description": "Parse the color string, and return the corresponding ARGB (alpha, red, green, blue) color.\nSupported formats are: #RRGGBB #AARRGGBB or one of the following names: 'red',\n'blue', 'green', 'black', 'white', 'gray', 'cyan', 'magenta', 'yellow', 'lightgray',\n'darkgray', 'grey', 'lightgrey', 'darkgrey', 'aqua', 'fuchsia', 'lime', 'maroon',\n'navy', 'olive', 'purple', 'silver', 'teal'.", "deprecated": "false", "params": [{ "name": "colorText", "type": "text"}], "returnType": "number"},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcCompassSensor",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a compass sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "CalibrationFailed", "description": "Whether calibration failed.", "type": "boolean", "rw": "read-only"},
    { "name": "CompassMode_CALIBRATION_MODE", "description": "The constant for CompassMode_CALIBRATION_MODE.", "type": "text", "rw": "read-only"},
    { "name": "CompassMode_MEASUREMENT_MODE", "description": "The constant for CompassMode_MEASUREMENT_MODE.", "type": "text", "rw": "read-only"},
    { "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Direction", "description": "The direction, in degrees.", "type": "number", "rw": "read-only"},
    { "name": "Status", "description": "The status.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "SetMode", "description": "Change to calibration or measurement mode.\nValid values are CompassMode_CALIBRATION_MODE or CompassMode_MEASUREMENT_MODE.", "deprecated": "false", "params": [{ "name": "compassMode", "type": "text"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcDcMotor",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a DC motor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "CurrentPosition", "description": "The current encoder value. If this motor has been set to REVERSE, the value will be multiplied by -1.", "type": "number", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Direction", "description": "Whether this motor should spin forward or reverse.\nValid values are Direction_FORWARD or Direction_REVERSE.", "type": "text", "rw": "read-write"},
    { "name": "Direction_FORWARD", "description": "The constant for Direction_FORWARD.", "type": "text", "rw": "read-only"},
    { "name": "Direction_REVERSE", "description": "The constant for Direction_REVERSE.", "type": "text", "rw": "read-only"},
    { "name": "Mode", "description": "The run mode.\nValid values are RunMode_RUN_USING_ENCODERS, RunMode_RUN_WITHOUT_ENCODERS, RunMode_RUN_TO_POSITION, or RunMode_RESET_ENCODERS.", "type": "text", "rw": "read-write"},
    { "name": "PortNumber", "description": "The port number.", "type": "number", "rw": "read-only"},
    { "name": "Power", "description": "The current motor power, between -1 and 1.", "type": "number", "rw": "read-write"},
    { "name": "RunMode_RESET_ENCODERS", "description": "The constant for RunMode_RESET_ENCODERS.", "type": "text", "rw": "read-only"},
    { "name": "RunMode_RUN_TO_POSITION", "description": "The constant for RunMode_RUN_TO_POSITION.", "type": "text", "rw": "read-only"},
    { "name": "RunMode_RUN_USING_ENCODERS", "description": "The constant for RunMode_RUN_USING_ENCODERS.", "type": "text", "rw": "read-only"},
    { "name": "RunMode_RUN_WITHOUT_ENCODERS", "description": "The constant for RunMode_RUN_WITHOUT_ENCODERS.", "type": "text", "rw": "read-only"},
    { "name": "TargetPosition", "description": "The motor target position. If this motor has been set to REVERSE, the value will be multiplied by -1.", "type": "number", "rw": "read-write"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "GetPowerFloat", "description": "Is motor power set to float?", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "IsBusy", "description": "Whether the motor is busy.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "SetPowerFloat", "description": "Allow the motor to float.", "deprecated": "false", "params": []},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcDcMotorController",
  "version": "3",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a DC motor controller of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "BatteryVoltage", "description": "Get the battery voltage, if supported by the controller.", "type": "number", "rw": "read-only"},
    { "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceMode_READ_ONLY", "description": "The constant for DeviceMode_READ_ONLY.", "type": "text", "rw": "read-only"},
    { "name": "DeviceMode_WRITE_ONLY", "description": "The constant for DeviceMode_WRITE_ONLY.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "MotorControllerDeviceMode", "description": "Set the device into read-only or write-only mode.\nValid values are DeviceMode_READ_ONLY or DeviceMode_WRITE_ONLY.", "type": "text", "rw": "read-write"},
    { "name": "RunMode_RESET_ENCODERS", "description": "The constant for RunMode_RESET_ENCODERS.", "type": "text", "rw": "read-only"},
    { "name": "RunMode_RUN_TO_POSITION", "description": "The constant for RunMode_RUN_TO_POSITION.", "type": "text", "rw": "read-only"},
    { "name": "RunMode_RUN_USING_ENCODERS", "description": "The constant for RunMode_RUN_USING_ENCODERS.", "type": "text", "rw": "read-only"},
    { "name": "RunMode_RUN_WITHOUT_ENCODERS", "description": "The constant for RunMode_RUN_WITHOUT_ENCODERS.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "GetDifferentialControlLoopCoefficientD", "description": "Get the differential control loop coefficient d, if supported by the controller.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "GetDifferentialControlLoopCoefficientI", "description": "Get the differential control loop coefficient i, if supported by the controller.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "GetDifferentialControlLoopCoefficientP", "description": "Get the differential control loop coefficient p, if supported by the controller.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "GetGearRatio", "description": "Get the gear ratio, if supported by the controller.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "GetMotorChannelMode", "description": "Get the current channel mode.\nValid values are RunMode_RUN_USING_ENCODERS, RunMode_RUN_WITHOUT_ENCODERS, RunMode_RUN_TO_POSITION, or RunMode_RESET_ENCODERS.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "text"},
    { "name": "GetMotorCurrentPosition", "description": "Get the current motor position.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "GetMotorPower", "description": "Get the current motor power.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "GetMotorPowerFloat", "description": "Allow motor to float.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "boolean"},
    { "name": "GetMotorTargetPosition", "description": "Get the current motor target position.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "number"},
    { "name": "IsBusy", "description": "Is the motor busy?", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}], "returnType": "boolean"},
    { "name": "SetDifferentialControlLoopCoefficients", "description": "Set the differential control loop coefficients, if supported by the controller.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"},{ "name": "p", "type": "number"},{ "name": "i", "type": "number"},{ "name": "d", "type": "number"}]},
    { "name": "SetGearRatio", "description": "Set the gear ratio (from -1.0 to 1.0), if supported by the controller.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"},{ "name": "ratio", "type": "number"}]},
    { "name": "SetMotorChannelMode", "description": "Set the current channel mode.\nValid values are RunMode_RUN_USING_ENCODERS, RunMode_RUN_WITHOUT_ENCODERS, RunMode_RUN_TO_POSITION, or RunMode_RESET_ENCODERS.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"},{ "name": "runMode", "type": "text"}]},
    { "name": "SetMotorPower", "description": "Set the current motor power (from -1.0 to 1.0).", "deprecated": "false", "params": [{ "name": "motor", "type": "number"},{ "name": "power", "type": "number"}]},
    { "name": "SetMotorPowerFloat", "description": "Allow motor to float.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"}]},
    { "name": "SetMotorPowerForGroup", "description": "Set the power for a group of motors, if supported by the controller.", "deprecated": "false", "params": [{ "name": "listOfFtcDcMotors", "type": "list"},{ "name": "power", "type": "number"}]},
    { "name": "SetMotorTargetPosition", "description": "Set the motor target position.", "deprecated": "false", "params": [{ "name": "motor", "type": "number"},{ "name": "position", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcDeviceInterfaceModule",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a device interface module of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Mode_INPUT", "description": "The constant for Mode_INPUT.", "type": "text", "rw": "read-only"},
    { "name": "Mode_OUTPUT", "description": "The constant for Mode_OUTPUT.", "type": "text", "rw": "read-only"},
    { "name": "SerialNumber", "description": "Get the USB serial number of this device.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [{ "name": "I2cPortIsReady", "description": "This event is triggered when an I2C port is ready, after the latest data has been read from the I2C Controller.\nThis event is only enabled if EnableI2cReadMode or EnableI2cWriteMode is used.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]}
],
  "methods": [{ "name": "CopyBufferIntoWriteBuffer", "description": "Copy a byte array into the buffer that is set to be written out to the device.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "byteArray", "type": "any"}]},
    { "name": "EnableI2cReadMode", "description": "Enable read mode for a particular I2C device and enable the I2cPortIsReady event for the given port.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "EnableI2cWriteMode", "description": "Enable write mode for a particular I2C device and enable the I2cPortIsReady event for the given port.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "GetAnalogInputValue", "description": "Return the current ADC results from the A0-A7 channel input pins.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"}], "returnType": "number"},
    { "name": "GetCopyOfReadBuffer", "description": "Get a copy of the most recent data read in from the device. (byte array)", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"}], "returnType": "any"},
    { "name": "GetCopyOfWriteBuffer", "description": "Get a copy of the data that is set to be written out to the device. (byte array)", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"}], "returnType": "any"},
    { "name": "GetDigitalChannelMode", "description": "Get the mode of a digital channel.\nValid values are Mode_INPUT or Mode_OUTPUT.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"}], "returnType": "text"},
    { "name": "GetDigitalChannelState", "description": "Get the state of a digital channel.\nIf it's in OUTPUT mode, this will return the output bit.\nIf the channel is in INPUT mode, this will return the input bit.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"}], "returnType": "boolean"},
    { "name": "GetDigitalIOControlByte", "description": "Get the digital IO control byte.", "deprecated": "false", "params": [], "returnType": "number"},
    { "name": "GetDigitalInputStateByte", "description": "A byte containing the current logic levels present in the D7-D0 channel pins. If a particular pin is in output mode, the current output state will be reported.", "deprecated": "false", "params": [], "returnType": "number"},
    { "name": "GetDigitalOutputStateByte", "description": "The D7-D0 output set field is a byte containing the required I\/O output of the D7-D0 channel pins. If the corresponding Dy-D0 I\/O control field bit is set to one, the channel pin will be in output mode and will reflect the value of the corresponding D7-D0 output set field bit.", "deprecated": "false", "params": [], "returnType": "number"},
    { "name": "GetLEDState", "description": "Indicates whether the LED on the given channel is on or not.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"}], "returnType": "boolean"},
    { "name": "GetPulseWidthOutputTime", "description": "Gets the pulse width for the channel output in units of 1 microsecond.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "number"},
    { "name": "GetPulseWidthPeriod", "description": "Gets the pulse repetition period for the channel output in units of 1 microsecond.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "number"},
    { "name": "IsI2cPortActionFlagSet", "description": "Get the port action flag; this flag is set if the particular port is busy.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "boolean"},
    { "name": "IsI2cPortInReadMode", "description": "Is the port in read mode?", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "boolean"},
    { "name": "IsI2cPortInWriteMode", "description": "Is the port in write mode?", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "boolean"},
    { "name": "IsI2cPortReady", "description": "Determine if a physical port is ready.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "boolean"},
    { "name": "ReadI2cCacheFromController", "description": "Read the local cache in from the I2C Controller.\nNOTE: unless this method is called the internal cache isn't updated.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]},
    { "name": "SetAnalogOutputFrequency", "description": "Sets the channel output frequency in the range 1-5,000 Hz in mode 1, 2 or 3.", "deprecated": "false", "params": [{ "name": "port", "type": "number"},{ "name": "frequency", "type": "number"}]},
    { "name": "SetAnalogOutputMode", "description": "Sets the channel operating mode.\nMode 0: Voltage output. Range: -4V - 4V.\nMode 1: Sine wave output. Range: 0 - 8V.\nMode 2: Square wave output. Range: 0 - 8V.\nMode 3: Triangle wave output. Range: 0 - 8V.", "deprecated": "false", "params": [{ "name": "port", "type": "number"},{ "name": "mode", "type": "number"}]},
    { "name": "SetAnalogOutputVoltage", "description": "Sets the channel output voltage.\nIf mode == 0: takes input from -1023-1023, output in the range -4 to +4 volts.\nIf mode == 1, 2, or 3: takes input from 0-1023, output in the range 0 to 8 volts.", "deprecated": "false", "params": [{ "name": "port", "type": "number"},{ "name": "voltage", "type": "number"}]},
    { "name": "SetDigitalChannelMode", "description": "Set the mode of a digital channel.\nValid values are Mode_INPUT or Mode_OUTPUT.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"},{ "name": "mode", "type": "text"}]},
    { "name": "SetDigitalChannelState", "description": "Set the state of a digital channel.\nThe behavior of this method is undefined for digital channels in INPUT mode.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"},{ "name": "state", "type": "boolean"}]},
    { "name": "SetDigitalIOControlByte", "description": "If a particular bit is set to one, the corresponding channel pin will be in output mode; else it will be in input mode.", "deprecated": "false", "params": [{ "name": "input", "type": "number"}]},
    { "name": "SetDigitalOutputByte", "description": "If a particular control field bit is set to one, the channel pin will be in output mode and will reflect the value of the corresponding field bit.", "deprecated": "false", "params": [{ "name": "input", "type": "number"}]},
    { "name": "SetI2cPortActionFlag", "description": "Set the port action flag; this flag tells the controller to send the current data in its buffer to the I2C device.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]},
    { "name": "SetLED", "description": "Turn on or off a particular LED.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"},{ "name": "state", "type": "boolean"}]},
    { "name": "SetPulseWidthOutputTime", "description": "Set the pulse width output time for this channel.\nTypically set to a value between 750 and 2,250 to control a servo.", "deprecated": "false", "params": [{ "name": "port", "type": "number"},{ "name": "time", "type": "number"}]},
    { "name": "SetPulseWidthPeriod", "description": "Set the pulse width output period.\nTypically set to 20,000 to control servo.", "deprecated": "false", "params": [{ "name": "port", "type": "number"},{ "name": "period", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"},
    { "name": "WriteI2cCacheToController", "description": "Write the local cache to the I2C Controller.\nNOTE: unless this method is called the internal cache isn't updated.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]},
    { "name": "WriteI2cPortFlagOnlyToController", "description": "Write just the port action flag in the local cache to the I2C controller.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]}]}
,
{ "name": "FtcDigitalChannel",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a single digital channel of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Mode", "description": "The mode of the digital channel.\nValid values are Mode_INPUT or Mode_OUTPUT.", "type": "text", "rw": "read-write"},
    { "name": "Mode_INPUT", "description": "The constant for Mode_INPUT.", "type": "text", "rw": "read-only"},
    { "name": "Mode_OUTPUT", "description": "The constant for Mode_OUTPUT.", "type": "text", "rw": "read-only"},
    { "name": "State", "description": "The state of the digital channel. If it's in OUTPUT mode, this will return the output bit. If the channel is in INPUT mode, this will return the input bit.", "type": "boolean", "rw": "read-write"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcElapsedTime",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for measuring elapsed time, with nanosecond accuracy, for an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [],
  "blockProperties": [{ "name": "StartTime", "description": "Get the relative start time.", "type": "number", "rw": "read-only"},
    { "name": "Time", "description": "Get the number of seconds since the start time, with nanosecond accuracy.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "Log", "description": "Log a message stating how long the timer has been running.", "deprecated": "false", "params": [{ "name": "label", "type": "text"}]},
    { "name": "Reset", "description": "Reset the start time to now.", "deprecated": "false", "params": []},
    { "name": "ToString", "description": "Return text stating the number of seconds that have passed.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcGamepad",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a gamepad of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "GamepadNumber", "editorType": "FtcGamepadNumber", "defaultValue": "1"}],
  "blockProperties": [{ "name": "A", "description": "The value of the A button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "AtRest", "description": "Are all analog sticks and triggers in their rest position? True or false.", "type": "boolean", "rw": "read-only"},
    { "name": "B", "description": "The value of the B button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "Back", "description": "The value of the Back button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "DpadDown", "description": "The dpad down value: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "DpadLeft", "description": "The dpad left value: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "DpadRight", "description": "The dpad right value: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "DpadUp", "description": "The dpad up value: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "GamepadNumber", "description": "The gamepad number.", "type": "number", "rw": "invisible"},
    { "name": "Guide", "description": "The value of the Guide button: true if pressed, false otherwise. The Guide button is often the large button in the middle of the controller.", "type": "boolean", "rw": "read-only"},
    { "name": "LeftBumper", "description": "The left bumper value: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "LeftStickButton", "description": "The value of the left stick button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "LeftStickX", "description": "The left analog stick horizontal axis value, as a numeric value between -1.0 and +1.0.", "type": "number", "rw": "read-only"},
    { "name": "LeftStickY", "description": "The left analog stick vertical axis value, as a numeric value between -1.0 and +1.0.", "type": "number", "rw": "read-only"},
    { "name": "LeftTrigger", "description": "The left trigger value, as a numeric value between 0.0 and +1.0.", "type": "number", "rw": "read-only"},
    { "name": "RightBumper", "description": "The right bumper value: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "RightStickButton", "description": "The value of the right stick button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "RightStickX", "description": "The right analog stick horizontal axis value, as a numeric value between -1.0 and +1.0.", "type": "number", "rw": "read-only"},
    { "name": "RightStickY", "description": "The right analog stick vertical axis value, as a numeric value between -1.0 and +1.0.", "type": "number", "rw": "read-only"},
    { "name": "RightTrigger", "description": "The right trigger value, as a numeric value between 0.0 and +1.0.", "type": "number", "rw": "read-only"},
    { "name": "Start", "description": "The value of the Start button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "Status", "description": "The status of the gamepad.", "type": "text", "rw": "read-only"},
    { "name": "Type", "description": "The type of gamepad.", "type": "text", "rw": "read-only"},
    { "name": "X", "description": "The value of the X button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"},
    { "name": "Y", "description": "The value of the Y button: true if pressed, false otherwise.", "type": "boolean", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "SetJoystickDeadzone", "description": "Set the joystick deadzone. Must be between 0 and 1.", "deprecated": "false", "params": [{ "name": "joystickDeadzone", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the gamepad.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcGyroSensor",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a gyro sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Heading", "description": "The integrated Z axis as a cartesian or cardinal heading, as a numeric value between 0 and 360. Not all gyro sensors support this feature.", "type": "number", "rw": "read-only"},
    { "name": "HeadingMode", "description": "The heading mode. Valid values are HeadingMode_CARTESIAN or HeadingMode_CARDINAL. Not all gyro sensors support this feature.", "type": "text", "rw": "read-write"},
    { "name": "HeadingMode_CARDINAL", "description": "The constant for HeadingMode_CARDINAL.", "type": "text", "rw": "read-only"},
    { "name": "HeadingMode_CARTESIAN", "description": "The constant for HeadingMode_CARTESIAN.", "type": "text", "rw": "read-only"},
    { "name": "RawX", "description": "The gyro sensor's raw X value. Not all gyro sensors support this feature.", "type": "number", "rw": "read-only"},
    { "name": "RawY", "description": "The gyro sensor's raw Y value. Not all gyro sensors support this feature.", "type": "number", "rw": "read-only"},
    { "name": "RawZ", "description": "The gyro sensor's raw Z value. Not all gyro sensors support this feature.", "type": "number", "rw": "read-only"},
    { "name": "Rotation", "description": "The rotation of this sensor. Not all gyro sensors support this feature.", "type": "number", "rw": "read-only"},
    { "name": "Status", "description": "The status.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "Calibrate", "description": "Calibrate the gyro. Not all gyro sensors support this feature. For the Modern Robotics device this will reset the Z axis heading.", "deprecated": "false", "params": []},
    { "name": "IsCalibrating", "description": "Is the gyro performing a calibration operation? Not all gyro sensors support this feature.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "ResetZAxisIntegrator", "description": "Set the integrated Z axis to zero. Not all gyro sensors support this feature.", "deprecated": "false", "params": []},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcI2cDevice",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an I2C device of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    ...
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [{ "name": "I2cPortIsReady", "description": "This event is triggered when the I2C port is ready. This event is only enabled if EnableI2cReadMode or EnableI2cWriteMode is used.", "deprecated": "false", "params": []}
],
  "methods": [{ "name": "CopyBufferIntoWriteBuffer", "description": "Copy a byte array into the buffer that is set to be written out to the device.", "deprecated": "false", "params": [{ "name": "byteArray", "type": "any"}]},
    { "name": "EnableI2cReadMode", "description": "Enable read mode for the I2C device and enable the I2cPortIsReady event.", "deprecated": "false", "params": [{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "EnableI2cWriteMode", "description": "Enable write mode for the I2C device and enable the I2cPortIsReady event.", "deprecated": "false", "params": [{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "GetCopyOfReadBuffer", "description": "Get a copy of the most recent data read in from the device. (byte array)", "deprecated": "false", "params": [], "returnType": "any"},
    { "name": "GetCopyOfWriteBuffer", "description": "Get a copy of the data that is set to be written out to the device. (byte array)", "deprecated": "false", "params": [], "returnType": "any"},
    { "name": "IsI2cPortActionFlagSet", "description": "Check whether or not the action flag is set for this I2C port.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "IsI2cPortInReadMode", "description": "Query whether or not the port is in Read mode.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "IsI2cPortInWriteMode", "description": "Query whether or not this port is in write mode.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "IsI2cPortReady", "description": "Query whether or not this I2c port is ready.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "ReadI2cCacheFromController", "description": "Trigger a read of the I2C cache.", "deprecated": "false", "params": []},
    { "name": "SetI2cPortActionFlag", "description": "Set the action flag for this I2C port.", "deprecated": "false", "params": []},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"},
    { "name": "WriteI2cCacheToController", "description": "Trigger a write of the I2C cache.", "deprecated": "false", "params": []},
    { "name": "WriteI2cPortFlagOnlyToController", "description": "Write only the action flag.", "deprecated": "false", "params": []}]}
,
{ "name": "FtcI2cDeviceReader",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an I2C device reader of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    ...
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "GetReadBuffer", "description": "Get a copy of the most recent data read in from the I2C device. (byte array)", "deprecated": "false", "params": [], "returnType": "any"},
    { "name": "Initialize", "description": "Initialize this I2C device reader", "deprecated": "false", "params": [{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcIrSeekerSensor",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an IR seeker sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "Angle", "description": "The angle.", "type": "number", "rw": "read-only"},
    { "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "I2cAddress", "description": "The I2C address of the IR seeker sensor.", "type": "number", "rw": "read-write"},
    { "name": "IndividualSensorCount", "description": "The number of individual IR sensors attached to this seeker.", "type": "number", "rw": "read-only"},
    { "name": "MAX_NEW_I2C_ADDRESS", "description": "The constant for MAX_NEW_I2C_ADDRESS.", "type": "number", "rw": "read-only"},
    { "name": "MIN_NEW_I2C_ADDRESS", "description": "The constant for MIN_NEW_I2C_ADDRESS.", "type": "number", "rw": "read-only"},
    { "name": "Mode", "description": "The mode of the IR seeker sensor.\nValid values are Mode_600HZ or Mode_1200HZ.", "type": "text", "rw": "read-write"},
    { "name": "Mode_1200HZ", "description": "The constant for Mode_1200HZ.", "type": "text", "rw": "read-only"},
    { "name": "Mode_600HZ", "description": "The constant for Mode_600HZ.", "type": "text", "rw": "read-only"},
    { "name": "SignalDetected", "description": "Whether a signal is detected by the sensor.", "type": "boolean", "rw": "read-only"},
    { "name": "SignalDetectedThreshold", "description": "The signal detection threshold of the IR seeker sensor.", "type": "number", "rw": "read-write"},
    { "name": "Strength", "description": "The strength.", "type": "number", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "IndividualSensorAngle", "description": "The angle of the individual IR sensor with the given zero-based position.", "deprecated": "false", "params": [{ "name": "position", "type": "number"}], "returnType": "number"},
    { "name": "IndividualSensorStrength", "description": "The strength of the individual IR sensor with the given zero-based position.", "deprecated": "false", "params": [{ "name": "position", "type": "number"}], "returnType": "number"},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcLED",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an LED of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    ...
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "Enable", "description": "Turn on or turn off the LED light.", "deprecated": "false", "params": [{ "name": "set", "type": "boolean"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcLegacyModule",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a legacy module of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  ...
  "methods": [{ "name": "CopyBufferIntoWriteBuffer", "description": "Copy a byte array into the buffer that is set to be written out to the device.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "byteArray", "type": "any"}]},
    { "name": "Enable9v", "description": "Enable or disable 9V power on a port.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "enable", "type": "boolean"}]},
    { "name": "EnableAnalogReadMode", "description": "Enable a physical port in analog read mode.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"}]},
    { "name": "EnableI2cReadMode", "description": "Enable read mode for a particular I2C device and enable the I2cPortIsReady event for the given port.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "EnableI2cWriteMode", "description": "Enable write mode for a particular I2C device and enable the I2cPortIsReady event for the given port.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "i2cAddress", "type": "number"},{ "name": "memAddress", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "GetCopyOfReadBuffer", "description": "Get a copy of the most recent data read in from the device. (byte array)", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"}], "returnType": "any"},
    { "name": "GetCopyOfWriteBuffer", "description": "Get a copy of the data that is set to be written out to the device. (byte array)", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"}], "returnType": "any"},
    ...
    { "name": "IsI2cPortInWriteMode", "description": "Is the port in write mode?", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "boolean"},
    { "name": "IsI2cPortReady", "description": "Determine if a physical port is ready.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}], "returnType": "boolean"},
    { "name": "ReadAnalog", "description": "Read an analog value from a device and return a byte array; only works in analog read mode.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"}], "returnType": "any"},
    { "name": "ReadI2cCacheFromController", "description": "Read the local cache in from the I2C Controller.\nNOTE: unless this method is called the internal cache isn't updated.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]},
    { "name": "SetDigitalLine", "description": "Set the value of digital line 0 or 1 while in analog mode.", "deprecated": "false", "params": [{ "name": "physicalPort", "type": "number"},{ "name": "line", "type": "number"},{ "name": "set", "type": "boolean"}]},
    { "name": "SetI2cPortActionFlag", "description": "Set the port action flag; this flag tells the controller to send the current data in its buffer to the I2C device.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"},
    { "name": "WriteI2cCacheToController", "description": "Write the local cache to the I2C Controller.\nNOTE: unless this method is called the internal cache isn't updated.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]},
    { "name": "WriteI2cPortFlagOnlyToController", "description": "Write just the port action flag in the local cache to the I2C controller.", "deprecated": "false", "params": [{ "name": "port", "type": "number"}]}]}
...
{ "name": "FtcLightSensor",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a light sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "LightDetected", "description": "The light detected by the sensor, on a scale of 0 to 1.", "type": "number", "rw": "read-only"},
    { "name": "LightDetectedRaw", "description": "The light detected by the sensor, as an integer.", "type": "number", "rw": "read-only"},
    { "name": "Status", "description": "The status.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "EnableLed", "description": "Enable the LED light.", "deprecated": "false", "params": [{ "name": "enable", "type": "boolean"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcLinearOpMode",
  "version": "3",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a linear operation mode for an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "OpModeName", "editorType": "string", "defaultValue": "Unnamed Op Mode"}],
  "blockProperties": [{ "name": "OpModeName", "description": "The name of this Op Mode.", "type": "text", "rw": "invisible"},
    { "name": "Time", "description": "The number of seconds this op mode had been running when the RunOpMode event was triggered.", "type": "number", "rw": "read-only"}],
  "events": [{ "name": "RunOpMode", "description": "This event is triggered when this op mode is run.", "deprecated": "false", "params": []}
],
  "methods": [{ "name": "GetRuntime", "description": "Get the number of seconds this op mode has been running.", "deprecated": "false", "params": [], "returnType": "number"},
    { "name": "OpModeIsActive", "description": "Returns true as long as the op mode is active.", "deprecated": "false", "params": [], "returnType": "boolean"},
    { "name": "Sleep", "description": "Sleep for the given amount of milliseconds.", "deprecated": "false", "params": [{ "name": "milliseconds", "type": "number"}]},
    { "name": "WaitForNextHardwareCycle", "description": "Wait for the start of the next hardware cycle.\nEach cycle of the hardware your commands are sent out to the hardware;\nand the latest data is read back in.\nThis method will wait for the current hardware cycle to finish, which is\nalso the start of the next hardware cycle.", "deprecated": "false", "params": []},
    { "name": "WaitForStart", "description": "Pause the Linear Op Mode until start has been pressed.", "deprecated": "false", "params": []},
    { "name": "WaitOneFullHardwareCycle", "description": "Wait for one full cycle of the hardware.\nEach cycle of the hardware your commands are sent out to the hardware;\nand the latest data is read back in.\nThis method has a strong guarantee to wait for at least one full hardware\nhardware cycle.", "deprecated": "false", "params": []}]}
,
{ "name": "FtcOpMode",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an operation mode for an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "OpModeName", "editorType": "string", "defaultValue": "Unnamed Op Mode"}],
  "blockProperties": [{ "name": "OpModeName", "description": "The name of this Op Mode.", "type": "text", "rw": "invisible"},
    { "name": "Time", "description": "The number of seconds this op mode had been running when the Loop event was triggered.", "type": "number", "rw": "read-only"}],
  "events": [{ "name": "Init", "description": "This event is triggered once when the INIT button is pressed.", "deprecated": "false", "params": []}
,
    { "name": "InitLoop", "description": "This event is triggered repeatedly when the INIT button is pressed.", "deprecated": "false", "params": []}
,
    { "name": "Loop", "description": "This event is triggered repeatedly while this op mode is running.", "deprecated": "false", "params": []}
,
    { "name": "Start", "description": "This event is triggered once when the PLAY button is first pressed.", "deprecated": "false", "params": []}
,
    { "name": "Stop", "description": "This event is triggered when this op mode is first disabled.", "deprecated": "false", "params": []}
],
  "methods": [{ "name": "GetRuntime", "description": "Get the number of seconds this op mode has been running.", "deprecated": "false", "params": [], "returnType": "number"}]}
,
{ "name": "FtcOpticalDistanceSensor",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an optical distance sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
...
{ "name": "FtcPwmOutput",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a PWM output device of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "PulseWidthOutputTime", "description": "The pulse width output time for this port.\nTypically set to a value between 750 and 2,250 to control a servo.", "type": "number", "rw": "read-write"},
    { "name": "PulseWidthPeriod", "description": "The pulse width output period.\nTypically set to 20,000 to control servo.", "type": "number", "rw": "read-write"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcRobotController",
  "version": "3",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "The primary FTC Robot Controller component",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "properties": [{ "name": "Configuration", "editorType": "string", "defaultValue": ""},
{ "name": "UsbScanTimeInSeconds", "editorType": "non_negative_integer", "defaultValue": "0"},
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True"}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the background color", "type": "number", "rw": "read-write"},
    { "name": "Column", "description": "", "type": "number", "rw": "invisible"},
    { "name": "Configuration", "description": "The name of the robot configuration.", "type": "text", "rw": "invisible"},
    { "name": "Height", "description": "", "type": "number", "rw": "read-write"},
    { "name": "HeightPercent", "description": "", "type": "number", "rw": "write-only"},
    { "name": "LIBRARY_VERSION", "description": "The constant for LIBRARY_VERSION.", "type": "text", "rw": "read-only"},
    { "name": "Row", "description": "", "type": "number", "rw": "invisible"},
    { "name": "TelemetrySorted", "description": "Whether the telemetry should be sorted by its keys on the driver station.", "type": "boolean", "rw": "read-write"},
    { "name": "UsbScanTimeInSeconds", "description": "The time reserved for scanning USB devices, in seconds.", "type": "number", "rw": "invisible"},
    { "name": "Visible", "description": "Specifies whether the component should be visible on the screen. Value is true if the component is showing and false if hidden.", "type": "boolean", "rw": "read-write"},
    { "name": "Width", "description": "", "type": "number", "rw": "read-write"},
    { "name": "WidthPercent", "description": "", "type": "number", "rw": "write-only"}],
  "events": [],
  "methods": [{ "name": "CopyBytes", "description": "Copies one or more bytes from the source byte array to the destination byte array.", "deprecated": "false", "params": [{ "name": "sourceByteArray", "type": "any"},{ "name": "sourcePosition", "type": "number"},{ "name": "destinationByteArray", "type": "any"},{ "name": "destinationPosition", "type": "number"},{ "name": "length", "type": "number"}]},
    { "name": "CreateByteArray", "description": "Create a byte array.", "deprecated": "false", "params": [{ "name": "length", "type": "number"}], "returnType": "any"},
    { "name": "Get1ByteNumberFromByteArray", "description": "Get a 1-byte number from a byte array.", "deprecated": "false", "params": [{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "unsigned", "type": "boolean"}], "returnType": "number"},
    { "name": "Get2ByteNumberFromByteArray", "description": "Get a 2-byte number from a byte array.", "deprecated": "false", "params": [{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "bigEndian", "type": "boolean"}], "returnType": "number"},
    { "name": "Get4ByteNumberFromByteArray", "description": "Get a 4-byte number from a byte array.", "deprecated": "false", "params": [{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "bigEndian", "type": "boolean"}], "returnType": "number"},
    { "name": "Get8ByteNumberFromByteArray", "description": "Get a 8-byte number from a byte array.", "deprecated": "false", "params": [{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "bigEndian", "type": "boolean"}], "returnType": "number"},
    { "name": "IsBitSet", "description": "Checks the state of a bit in a bit field. Returns true if the target bit is one.", "deprecated": "false", "params": [{ "name": "bitField", "type": "number"},{ "name": "bitPosition", "type": "number"}], "returnType": "boolean"},
    { "name": "LengthOfByteArray", "description": "Returns the length of a byte array.", "deprecated": "false", "params": [{ "name": "byteArray", "type": "any"}], "returnType": "number"},
    { "name": "LogDevices", "description": "Log information about hardware devices.", "deprecated": "false", "params": []},
    { "name": "Put1ByteNumberIntoByteArray", "description": "Put a 1-byte number into a byte array.", "deprecated": "false", "params": [{ "name": "number", "type": "text"},{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"}]},
    { "name": "Put2ByteNumberIntoByteArray", "description": "Put a 2-byte number into a byte array.", "deprecated": "false", "params": [{ "name": "number", "type": "number"},{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "bigEndian", "type": "boolean"}]},
    { "name": "Put4ByteNumberIntoByteArray", "description": "Put a 4-byte number into a byte array.", "deprecated": "false", "params": [{ "name": "number", "type": "number"},{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "bigEndian", "type": "boolean"}]},
    { "name": "Put8ByteNumberIntoByteArray", "description": "Put a 8-byte number into a byte array.", "deprecated": "false", "params": [{ "name": "number", "type": "number"},{ "name": "byteArray", "type": "any"},{ "name": "position", "type": "number"},{ "name": "bigEndian", "type": "boolean"}]},
    { "name": "RangeClip", "description": "Clip number if number is less than min or greater than max", "deprecated": "false", "params": [{ "name": "number", "type": "number"},{ "name": "min", "type": "number"},{ "name": "max", "type": "number"}], "returnType": "number"},
    { "name": "RangeScale", "description": "Scale a number in the range of x1 to x2, to the range of y1 to y2", "deprecated": "false", "params": [{ "name": "number", "type": "number"},{ "name": "x1", "type": "number"},{ "name": "x2", "type": "number"},{ "name": "y1", "type": "number"},{ "name": "y2", "type": "number"}], "returnType": "number"},
    { "name": "TelemetryAddNumericData", "description": "Adds a numeric data point to the telemetry for the active op mode.", "deprecated": "false", "params": [{ "name": "key", "type": "text"},{ "name": "number", "type": "text"}]},
    { "name": "TelemetryAddTextData", "description": "Adds a text data point to the telemetry for the active op mode.", "deprecated": "false", "params": [{ "name": "key", "type": "text"},{ "name": "text", "type": "text"}]}]}
,
{ "name": "FtcServo",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a servo of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Direction", "description": "Whether this servo should spin forward or reverse.\nValid values are Direction_FORWARD or Direction_REVERSE.", "type": "text", "rw": "read-write"},
    { "name": "Direction_FORWARD", "description": "The constant for Direction_FORWARD.", "type": "text", "rw": "read-only"},
    { "name": "Direction_REVERSE", "description": "The constant for Direction_REVERSE.", "type": "text", "rw": "read-only"},
    { "name": "MAX_POSITION", "description": "The constant for MAX_POSITION.", "type": "number", "rw": "read-only"},
    { "name": "MIN_POSITION", "description": "The constant for MIN_POSITION.", "type": "number", "rw": "read-only"},
    { "name": "PortNumber", "description": "The port number.", "type": "number", "rw": "read-only"},
    { "name": "Position", "description": "The current servo position, between 0.0 and 1.0.", "type": "number", "rw": "read-write"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ScaleRange", "description": "Sets the scale range of this servo.", "deprecated": "false", "params": [{ "name": "min", "type": "number"},{ "name": "max", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcServoController",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a servo controller of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "PwmStatus_DISABLED", "description": "The constant for PwmStatus_DISABLED.", "type": "text", "rw": "read-only"},
    { "name": "PwmStatus_ENABLED", "description": "The constant for PwmStatus_ENABLED.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "GetPwmStatus", "description": "Get the PWM status.\nValid values are PwmStatus_ENABLED or PwmStatus_DISABLED.", "deprecated": "false", "params": [], "returnType": "text"},
    { "name": "GetServoPosition", "description": "Get the position of a servo at a given channel.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"}], "returnType": "number"},
    { "name": "PwmDisable", "description": "PWM disable.", "deprecated": "false", "params": []},
    { "name": "PwmEnable", "description": "PWM enable.", "deprecated": "false", "params": []},
    { "name": "SetServoPosition", "description": "Set the position of a servo at the given channel.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"},{ "name": "position", "type": "number"}]},
    { "name": "SetServoPositionAndSpeed", "description": "Set a position and a speed for a servo. The speed parameter is ignored if it is not supported by the controller.", "deprecated": "false", "params": [{ "name": "channel", "type": "number"},{ "name": "position", "type": "number"},{ "name": "speed", "type": "number"}]},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcTouchSensor",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a touch sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "IsPressed", "description": "Return true if the touch sensor is being pressed.", "type": "boolean", "rw": "read-only"},
    { "name": "Status", "description": "The status, if supported by the touch sensor.", "type": "text", "rw": "read-only"},
    { "name": "Value", "description": "Represents how much force is applied to the touch sensor; for some touch sensors this value will only ever be 0 or 1.", "type": "number", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcTouchSensorMultiplexer",
  "version": "2",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a touch sensor multiplexer of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    { "name": "Device", "description": "The manufacturer and name of the device.", "type": "text", "rw": "read-only"},
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Status", "description": "The status, if supported by the touch sensor multiplexer.", "type": "text", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "GetSwitches", "description": "Get switches", "deprecated": "false", "params": [], "returnType": "number"},
    { "name": "IsTouchSensorPressed", "description": "Is the touch sensor pressed?", "deprecated": "false", "params": [{ "name": "channel", "type": "number"}], "returnType": "boolean"},
    { "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcUltrasonicSensor",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for an ultrasonic sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    ...
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Status", "description": "The status.", "type": "text", "rw": "read-only"},
    { "name": "UltrasonicLevel", "description": "The ultrasonic level.", "type": "number", "rw": "read-only"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
{ "name": "FtcVoltageSensor",
  "version": "1",
  "categoryString": "FIRSTTECHCHALLENGE",
  "helpString": "A component for a voltage sensor of an FTC robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/ftc.png",
  "properties": [{ "name": "DeviceName", "editorType": "string", "defaultValue": ""}],
  "blockProperties": [{ "name": "ConnectionInfo", "description": "The connection information.", "type": "text", "rw": "read-only"},
    ...
    { "name": "DeviceName", "description": "The name for the hardware device.", "type": "text", "rw": "invisible"},
    { "name": "Version", "description": "The version.", "type": "number", "rw": "read-only"},
    { "name": "Voltage", "description": "The voltage.", "type": "number", "rw": "read-only"}],
  "events": [],
  "methods": [{ "name": "ToString", "description": "Return text representing the state of the hardware device.", "deprecated": "false", "params": [], "returnType": "text"}]}
,
...
{ "name": "GyroscopeSensor",
  ...
  "properties": [{ "name": "Enabled", "editorType": "boolean", "defaultValue": "True"}],
  "blockProperties": [{ "name": "Available", "description": "Indicates whether a gyroscope sensor is available.", "type": "boolean", "rw": "read-only"},
    { "name": "Enabled", "description": "If enabled, then sensor events will be generated and XAngularVelocity, YAngularVelocity, and ZAngularVelocity properties will have meaningful values.", "type": "boolean", "rw": "read-write"},
    { "name": "XAngularVelocity", "description": "The angular velocity around the X axis, in degrees per second.", "type": "number", "rw": "read-only"},
    { "name": "YAngularVelocity", "description": "The angular velocity around the Y axis, in degrees per second.", "type": "number", "rw": "read-only"},
    { "name": "ZAngularVelocity", "description": "The angular velocity around the Z axis, in degrees per second.", "type": "number", "rw": "read-only"}],
